...
namespace UpGearShop.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Product>().HasData(new { Id = 1, imageURL = "/images/products-images/dryGinHat.jpg", NewProduct = true, Name = "Coco", Price = (decimal)23 }) ;
            ...
            builder.Entity<Product>().HasData(new { Id = 3, imageURL = "/images/products-images/uglyShoes.jpg", NewProduct = false, Name = "Yeezys", Price = (decimal)12.99 });
            ...
            builder.Entity<Product>().HasData(new { Id = 6, imageURL = "/images/products-images/yeezys2.jpg", NewProduct = true, Name = "Hunger", Price = (decimal)23 });
            builder.Entity<Product>().HasData(new { Id = 7, imageURL = "/images/products-images/yeezys3.jpg", NewProduct = false, Name = "Hunger", Price = (decimal)23 });
